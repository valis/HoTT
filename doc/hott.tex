...
\[ Tm ::= v_i\ |\ U_\alpha\ |\ \Pi_n A\,B\ |\ \lambda_n b\ |\ app\ n\ f\ a\ |\ \Sigma_n A\,B\ |\ a , b\ |\ proj_1\ n\ p\ |\ proj_2\ n\ p\ | \]
\[ Id_n A\,a\,a' \ |\ idp\ a\ |\ pmap\ p\ q\ |\ inv\ n\ p\ |\ comp\ k\ n\ p\ q\ |\ coe\ n\ p, \]
\[ Ctx ::= \epsilon\ |\ \Gamma, A, \]
...
We write $\Pi\,A\,B$ for $\Pi_0\,A\,B$, $\Sigma\,A\,B$ for $\Sigma_0\,A\,B$, $a = a' \,|\, A$ for $Id_0 A\,a\,a'$, and $\lambda b$ for $\lambda_0 b$.
