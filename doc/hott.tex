...
\begin{center}
\AxiomC{}
\UnaryInfC{$\varnothing \vdash_n$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash_n A$}
\RightLabel{, $x \notin \Gamma$}
\UnaryInfC{$\Gamma, x : A \vdash_n$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash_n$}
\RightLabel{, $x : A \in \Gamma$}
\UnaryInfC{$\Gamma \vdash_n x : A$}
\DisplayProof
\end{center}
...
\begin{center}
\AxiomC{$\Gamma \vdash_n A$}
\AxiomC{$\Gamma, x : A \vdash_n B$}
\BinaryInfC{$\Gamma \vdash_n \Pi (x : A) B$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash_n A$}
\AxiomC{$\Gamma, A \vdash_n B$}
\BinaryInfC{$\Gamma \vdash_n \Sigma (x : A) B$}
\DisplayProof
\end{center}

\medskip
\begin{center}
\AxiomC{$\Gamma, x : A \vdash_n b : B$}
\UnaryInfC{$\Gamma \vdash_n \lambda x. b : \Pi (x : A) B$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash_n f : \Pi (x : A) B$}
\AxiomC{$\Gamma \vdash_n a : A$}
\BinaryInfC{$\Gamma \vdash_n f\ a : B[x := a]$}
\DisplayProof
\end{center}
...
\begin{center}
\AxiomC{$\Gamma \vdash_n a : A$}
\AxiomC{$\Gamma \vdash_n b : B[x := a]$}
\AxiomC{$\Gamma, x : A \vdash_n B$}
\TrinaryInfC{$\Gamma \vdash_n a, b : \Sigma (x : A) B$}
\DisplayProof
\end{center}

\medskip
\begin{center}
\AxiomC{$\Gamma \vdash_n p : \Sigma (x : A) B$}
\UnaryInfC{$\Gamma \vdash_n proj_1\ p : A$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash_n p : \Sigma (x : A) B$}
\UnaryInfC{$\Gamma \vdash_n proj_2\ p : B[x := proj_1\ p]$}
\DisplayProof
\end{center}
