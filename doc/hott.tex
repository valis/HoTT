...
Define $\mathcal{N}\!e_n \in \mathscr{M}_n$ as follows:
\[ \mathcal{N}\!e_n(x_1, \ldots x_n) = \{ \mathsf{Ne}(s,e,c)\,|\,e \in TM \text{ and } s(i) = x_{i+1} \text{ for all } 0 \leq i < n \}. \]
...
\begin{center}
\AxiomC{}
\UnaryInfC{$(\mathsf{Ne}(s,e,c), \mathcal{N}\!e_n) \in G^\alpha_n$}
\DisplayProof
\quad
\AxiomC{}
