...
\AxiomC{$\Gamma, A, A, v_1 = v_0\,|\,idp\ A \vdash\ \Uparrow^2_1\hspace{-.4em} B :\ \Uparrow^2\hspace{-.5em} B_0 =\ \Uparrow^1_1 \Uparrow^1\hspace{-.5em} B_1\,|\,idp\ U_\delta$}
\BinaryInfC{$\Gamma \vdash \Pi_1 A B : \Pi A_0 B_0 = \Pi A_1 B_1\,|\,idp\ U_{max(\alpha, \beta, \gamma, \delta)}$}
\DisplayProof
\end{center}
