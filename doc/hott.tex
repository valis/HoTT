...
\RightLabel{, $\llbracket A \rrbracket^{\rho_\Gamma}_\diamond = \llbracket B \rrbracket^{\rho_\Gamma}_\diamond$}
...
\AxiomC{$(b(id_\diamond, d), B(d)) \in G_\alpha \text{ for all } d \in A$}
\BinaryInfC{$(\mathsf{Sigma}(\diamond, a, b), \mathcal{S}igma A B) \in G_\alpha$}
\DisplayProof
\end{center}
...
\AxiomC{$(a, A) \in G_\alpha$}
\AxiomC{$(b(id_\diamond, d), B(d)) \in G_\alpha \text{ for all } d \in A$}
\BinaryInfC{$(\mathsf{Pi}(\diamond, a, b), \mathcal{P}i A B) \in G_\alpha$}
\DisplayProof
\end{center}
...
\begin{center}
\AxiomC{$(a, A) \in G_\alpha$}
\UnaryInfC{$(\mathsf{Id}(\diamond, a, x, y), \mathcal{I}d\,A) \in G_\alpha$}
\DisplayProof
\end{center}
\medskip
...
\AxiomC{$b(id_\diamond, d) \in \mathcal{U}_\alpha \text{ for all } d \in [a]_\alpha$}
\BinaryInfC{$\mathsf{Sigma}(\diamond, a, b) \in \mathcal{U}_\alpha$}
\DisplayProof
\end{center}
...
\AxiomC{$a \in \mathcal{U}_\alpha$}
\AxiomC{$b(id_\diamond, d) \in \mathcal{U}_\alpha \text{ for all } d \in [a]_\alpha$}
\BinaryInfC{$\mathsf{Pi}(\diamond, a, b) \in \mathcal{U}_\alpha$}
\DisplayProof
\end{center}
...
\quad
\AxiomC{$a \in \mathcal{U}_\alpha$}
\UnaryInfC{$\mathsf{Id}(\diamond, a, x, y) \in \mathcal{U}_\alpha$}
\DisplayProof
\quad
\end{center}
...
\quad
\AxiomC{$\Gamma \models$}
\AxiomC{$\llbracket A \rrbracket^\rho_\diamond \in \mathcal{U} \text{ for all } \rho \in [\Gamma]$}
