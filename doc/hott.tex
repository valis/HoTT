...
\item[] $\mathsf{comp}(k, n, \mathsf{Lam}(f), \mathsf{Lam}(f')) = $ \\
    \indent $\mathsf{Lam}((m,a) \mapsto \mathsf{comp}(k, dom(m), f(m, \delta^{dom(m)}_0 \cdot \tau^0_{dom(m)} \cdot a), f'(m, a)))$
...
\item[] $\mathsf{comp}(k, n, \mathsf{Sigma}(A,B), \mathsf{Sigma}(A',B')) = \mathsf{Sigma}(\mathsf{comp}(n, A, A'), \mathsf{comp}(n, B, B'))$
\item[] $\mathsf{comp}(k, n, \mathsf{Pi}(A,B), \mathsf{Pi}(A',B')) = \mathsf{Pi}(\mathsf{comp}(n, A, A'), \mathsf{comp}(n, B, B'))$
\item[] $\mathsf{comp}(k, n, \mathsf{Id}(A,a,a'), \mathsf{Id}(B,b,b')) =$ \\
    \indent $\mathsf{Id}(\mathsf{comp}(n + 1, A, B), \mathsf{comp}(n, a, b), \mathsf{comp}(n, a', b'))$
